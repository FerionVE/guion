...
pub fn _render<W: IButton<E> + 'static, E: Env + 'static>(mut l: Link<E>, mut r: RenderLink<E>) where ERenderer<E>: RenderStdWidgets<E>, ECHandler<E>: AsHandlerStateful<E>, EEvent<E>: VariantSupport<KbdDown<EEKey<E>>,E> {
    let senf = l.me::<W>();
    let down = 
