...
// use super::Widget;
// use super::cache::{DynRenderCache, RenderCache};
...
//     type WidgetCache: RenderCache<E>; // this ugly hack as we can't even refer to 'static types behind lifetime GATs without effect of these lifetimes
