...
impl<'l:'s,'s,E: Env> Resolvable<'l,E> {
    #[inline]
    pub unsafe fn short_lt(self) -> Resolvable<'s,E> {
        match self {
...
pub trait ShortResolvableRef<'l,'s,'y,E> where 'l: 's, 'l: 'y, 's: 'y, E: Env {
    unsafe fn short_lt(self) -> &'y Resolvable<'s,E>;
}
...
impl<'l:'s,'s,E: Env> ResolvableMut<'l,E> {
    #[inline]
    pub unsafe fn short_lt(self) -> ResolvableMut<'s,E> {
        match self {
...
pub trait ShortResolvableVec<'l,'s,E> where 'l: 's, E: Env {
    unsafe fn short_lt(self) -> Vec<Resolvable<'s,E>>;
}
...
impl<'l:'s,'s,E: Env> Resolved<'l,E> {
    #[inline]
    pub unsafe fn short_lt(self) -> Resolved<'s,E> {
        Resolved{
...
impl<'l:'s,'s,E: Env> ResolvedMut<'l,E> {
    #[inline]
    pub unsafe fn short_lt(self) -> ResolvedMut<'s,E> {
        ResolvedMut{
            wref: self.wref.short_lt(),
            path: self.path,
        }
...
pub trait ShortResolvedRef<'l,'s,'y,E> where 'l: 's, 'l: 'y, 's: 'y, E: Env {
    unsafe fn short_lt(self) -> &'y Resolved<'s,E>;
}
...
pub trait ShortWidgetRef<'l,'s,E> where 'l: 's, E: Env {
    unsafe fn short_lt(self) -> WidgetRef<'s,E>;
}
...
pub trait ShortWidgetRefMut<'l,'s,E> where 'l: 's, E: Env {
    unsafe fn short_lt(self) -> WidgetRefMut<'s,E>;
}
...
pub trait ShortRefWidgetRef<'l,'s,'y,E> where 'l: 's, 's: 'y, 'l: 'y, E: Env {
    unsafe fn short_lt(self) -> &'y dyn Widget<'s,E>;
}
...
pub trait ShortRefWidgetMut<'l,'s,'y,E> where 'l: 's, 's: 'y, 'l: 'y, E: Env {
    unsafe fn short_lt(self) -> &'y mut dyn WidgetMut<'s,E>;
}
