...
pub trait WidgetPath<E>: AsWPSlice<E> + AsWidget<E> + AsWidgetImmediate<'static,E> + AsWidgetImmediateMut<'static,E> + Clone + PartialEq + Sized + Send + Sync + 'static where E: Env<WidgetPath=Self> {
    ...
    #[inline]
    fn render_of_slice(s: WPSlice<E>, c: CtxRef<E>, r: &mut RenderLink<E>) -> Result<bool,()> {
        Ok( c.1.render(c.0.widget(s)?,r) )
    }
    #[inline]
    fn event_of_slice(s: WPSlice<E>, c: CtxRef<E>, e: (EEvent<E>,&Bounds,u64)) -> Result<(),()> {
...
impl<'a,E> WPSlice<'a,E> where E: Env {
    ...
    #[inline]
    pub fn render(&self, c: CtxRef<E>, r: &mut RenderLink<E>) -> Result<bool,()> {
        E::WidgetPath::render_of_slice(*self,c,r)
    }
    #[inline]
    pub fn event(&self, c: CtxRef<E>, e: (EEvent<E>,&Bounds,u64)) -> Result<(),()> {
